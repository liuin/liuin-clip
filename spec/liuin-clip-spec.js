...
import LiuinClip from '../lib/liuin-clip';
...
describe('LiuinClip', () => {
  ...
  beforeEach(() => {
    ...
    activationPromise = atom.packages.activatePackage('liuin-clip');
  });

  describe('when the liuin-clip:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        expect(workspaceElement.querySelector('.liuin-clip')).toExist();
